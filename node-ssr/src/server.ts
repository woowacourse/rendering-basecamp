...
import { getMetaTagsHTML, getMovieListHTML } from './utils/getMetaTags';
...
app.get('/', async (req: Request, res: Response) => {
  ...
  const metaTags = getMetaTagsHTML({
  ...
  const movieList = getMovieListHTML(movies);
...
app.get('/detail/:id', async (req: Request, res: Response) => {
  ...
  const metaTags = getMetaTagsHTML({
    ...
    description: movie.overview || `${movie.title}의 상세 정보를 확인하세요.`,
    imageUrl: imageUrl,
    pageUrl: url,
  });
  ...
  res.send(/*html*/ `
    ...
    <html lang="ko">
      ...
      <body>
        <div id="wrap">
          <header>
            <div class="background-container" style="background-image: url(https://image.tmdb.org/t/p/w1920_and_h800_multi_faces${movie.backdrop_path});">
              <div class="overlay"></div>
              <div class="top-rated-container">
                <img src="/images/logo.png" width="117" height="20" class="logo" alt="MovieLogo" />
                <div class="top-rated-movie">
        ...
        <div class="modal-background active">
          <div class="modal">
            ...
            <div class="modal-container">
              <img src="https://image.tmdb.org/t/p/original${movie.poster_path}" alt="${movie.title}" class="modal-image" />
              <div class="modal-description">
                <div class="movie-info-line">
                  <span class="movie-meta">${movie.genres.map((g: any) => g.name).join(', ')}</span>
