...
export const MovieDetailModal = ({ movie, onClose }: MovieDetailModalProps) => {
  ...
  const imageUrl = poster_path ? `https://image.tmdb.org/t/p/original${poster_path}` : '/images/no_image.png';
          ...
          <div className="modal-description">
            ...
            <div className="movie-info-line">
              ...
              <div className="movie-rating">
                <Image src="/images/star_filled.png" width="16" height="16" alt="star" />
